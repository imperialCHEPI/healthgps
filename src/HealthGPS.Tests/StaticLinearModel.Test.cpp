...
class StaticLinearModelTest : public ::testing::Test {
  protected:
    ...
    void create_test_cholesky_matrices() {
        ...
        policy_covariance << 1.0, 0.2, 0.2, 1.0;
...
TEST_F(StaticLinearModelTest, ConstructorWithNullTrend) {
    auto model = std::make_unique<StaticLinearModel>(
        ...
        lambda_, stddev_, cholesky_, policy_models_, policy_ranges_, policy_cholesky_, nullptr,
        nullptr, nullptr, // No trend models
        info_speed_, rural_prevalence_, income_models_, physical_activity_stddev_, TrendType::Null,
...
TEST_F(StaticLinearModelTest, ConstructorWithRegularTrend) {
    auto model = std::make_unique<StaticLinearModel>(
        ...
        physical_activity_stddev_, TrendType::Trend, nullptr, nullptr, nullptr, nullptr, nullptr,
...
TEST_F(StaticLinearModelTest, ConstructorWithIncomeTrend) {
    auto model = std::make_unique<StaticLinearModel>(
        ...
        lambda_, stddev_, cholesky_, policy_models_, policy_ranges_, policy_cholesky_,
        trend_models_, trend_ranges_, trend_lambda_, info_speed_, rural_prevalence_, income_models_,
        physical_activity_stddev_, TrendType::IncomeTrend, expected_income_trend_,
        expected_income_trend_boxcox_, income_trend_steps_, income_trend_models_,
        income_trend_ranges_, income_trend_lambda_, income_trend_decay_factors_, true);
...
TEST_F(StaticLinearModelTest, ConstructorWithNoActivePolicies) {
    auto model = std::make_unique<StaticLinearModel>(
        expected_, expected_trend_, trend_steps_, expected_trend_boxcox_, names_, models_, ranges_,
        lambda_, stddev_, cholesky_, policy_models_, policy_ranges_, policy_cholesky_, nullptr,
        nullptr, nullptr, info_speed_, rural_prevalence_, income_models_, physical_activity_stddev_,
...
TEST_F(StaticLinearModelTest, StaticLinearModelDefinitionConstructor) {
    auto definition = std::make_unique<StaticLinearModelDefinition>(
        ...
        std::move(trend_models_), std::move(trend_ranges_), std::move(trend_lambda_), info_speed_,
        std::move(rural_prevalence_), std::move(income_models_), physical_activity_stddev_,
...
TEST_F(StaticLinearModelTest, StaticLinearModelDefinitionWithIncomeTrend) {
    auto definition = std::make_unique<StaticLinearModelDefinition>(
        ...
        std::move(trend_models_), std::move(trend_ranges_), std::move(trend_lambda_), info_speed_,
        std::move(rural_prevalence_), std::move(income_models_), physical_activity_stddev_,
        TrendType::IncomeTrend, std::move(expected_income_trend_),
...
TEST_F(StaticLinearModelTest, StaticLinearModelDefinitionValidation) {
    ...
    EXPECT_THROW(StaticLinearModelDefinition(
                     ...
                     std::make_shared<std::unordered_map<Identifier, double>>(), empty_names,
                     models_, ranges_, lambda_, stddev_, cholesky_, policy_models_, policy_ranges_,
                     policy_cholesky_, nullptr, nullptr, nullptr, info_speed_, rural_prevalence_,
                     income_models_, physical_activity_stddev_, TrendType::Null, nullptr, nullptr,
...
TEST_F(StaticLinearModelTest, StaticLinearModelDefinitionEmptyModels) {
    ...
    EXPECT_THROW(StaticLinearModelDefinition(
                     ...
                     std::make_shared<std::unordered_map<Identifier, double>>(),
                     std::make_shared<std::unordered_map<Identifier, int>>(),
                     std::make_shared<std::unordered_map<Identifier, double>>(), names_,
                     empty_models, ranges_, lambda_, stddev_, cholesky_, policy_models_,
                     policy_ranges_, policy_cholesky_, nullptr, nullptr, nullptr, info_speed_,
                     rural_prevalence_, income_models_, physical_activity_stddev_, TrendType::Null,
                     nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, true),
                 HgpsException);
}
...
TEST_F(StaticLinearModelTest, StaticLinearModelDefinitionEmptyRanges) {
    ...
    EXPECT_THROW(StaticLinearModelDefinition(
                     ...
                     std::make_shared<std::unordered_map<Identifier, double>>(),
                     std::make_shared<std::unordered_map<Identifier, int>>(),
                     std::make_shared<std::unordered_map<Identifier, double>>(), names_, models_,
                     empty_ranges, lambda_, stddev_, cholesky_, policy_models_, policy_ranges_,
                     policy_cholesky_, nullptr, nullptr, nullptr, info_speed_, rural_prevalence_,
                     income_models_, physical_activity_stddev_, TrendType::Null, nullptr, nullptr,
                     nullptr, nullptr, nullptr, nullptr, nullptr, true),
                 HgpsException);
...
TEST_F(StaticLinearModelTest, StaticLinearModelDefinitionEmptyLambda) {
    ...
    EXPECT_THROW(StaticLinearModelDefinition(
                     ...
                     std::make_shared<std::unordered_map<Identifier, int>>(),
                     std::make_shared<std::unordered_map<Identifier, double>>(), names_, models_,
                     ranges_, empty_lambda, stddev_, cholesky_, policy_models_, policy_ranges_,
                     policy_cholesky_, nullptr, nullptr, nullptr, info_speed_, rural_prevalence_,
                     income_models_, physical_activity_stddev_, TrendType::Null, nullptr, nullptr,
                     nullptr, nullptr, nullptr, nullptr, nullptr, true),
                 HgpsException);
...
TEST_F(StaticLinearModelTest, StaticLinearModelDefinitionEmptyStdDev) {
    ...
    EXPECT_THROW(StaticLinearModelDefinition(
                     ...
                     std::make_shared<std::unordered_map<Identifier, int>>(),
                     std::make_shared<std::unordered_map<Identifier, double>>(), names_, models_,
                     ranges_, lambda_, empty_stddev, cholesky_, policy_models_, policy_ranges_,
                     policy_cholesky_, nullptr, nullptr, nullptr, info_speed_, rural_prevalence_,
                     income_models_, physical_activity_stddev_, TrendType::Null, nullptr, nullptr,
                     nullptr, nullptr, nullptr, nullptr, nullptr, true),
                 HgpsException);
...
TEST_F(StaticLinearModelTest, StaticLinearModelDefinitionEmptyPolicyModels) {
    ...
    EXPECT_THROW(StaticLinearModelDefinition(
                     ...
                     std::make_shared<std::unordered_map<Identifier, int>>(),
                     std::make_shared<std::unordered_map<Identifier, double>>(), names_, models_,
                     ranges_, lambda_, stddev_, cholesky_, empty_policy_models, policy_ranges_,
                     policy_cholesky_, nullptr, nullptr, nullptr, info_speed_, rural_prevalence_,
                     income_models_, physical_activity_stddev_, TrendType::Null, nullptr, nullptr,
                     nullptr, nullptr, nullptr, nullptr, nullptr, true),
                 HgpsException);
...
TEST_F(StaticLinearModelTest, StaticLinearModelDefinitionEmptyPolicyRanges) {
    ...
    EXPECT_THROW(StaticLinearModelDefinition(
                     ...
                     std::make_shared<std::unordered_map<Identifier, int>>(),
                     std::make_shared<std::unordered_map<Identifier, double>>(), names_, models_,
                     ranges_, lambda_, stddev_, cholesky_, policy_models_, empty_policy_ranges,
                     policy_cholesky_, nullptr, nullptr, nullptr, info_speed_, rural_prevalence_,
                     income_models_, physical_activity_stddev_, TrendType::Null, nullptr, nullptr,
                     nullptr, nullptr, nullptr, nullptr, nullptr, true),
                 HgpsException);
...
TEST_F(StaticLinearModelTest, StaticLinearModelDefinitionEmptyRuralPrevalence) {
    ...
    EXPECT_THROW(StaticLinearModelDefinition(
                     ...
                     std::make_shared<std::unordered_map<Identifier, int>>(),
                     std::make_shared<std::unordered_map<Identifier, double>>(), names_, models_,
                     ranges_, lambda_, stddev_, cholesky_, policy_models_, policy_ranges_,
                     policy_cholesky_, nullptr, nullptr, nullptr, info_speed_,
                     empty_rural_prevalence, income_models_, physical_activity_stddev_,
                     TrendType::Null, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr,
                     true),
                 HgpsException);
}
...
TEST_F(StaticLinearModelTest, StaticLinearModelDefinitionEmptyIncomeModels) {
    ...
    EXPECT_THROW(StaticLinearModelDefinition(
                     ...
                     ranges_, lambda_, stddev_, cholesky_, policy_models_, policy_ranges_,
                     policy_cholesky_, nullptr, nullptr, nullptr, info_speed_, rural_prevalence_,
                     empty_income_models, physical_activity_stddev_, TrendType::Null, nullptr,
...
TEST_F(StaticLinearModelTest, StaticLinearModelDefinitionTrendValidation) {
    ...
    EXPECT_THROW(
        StaticLinearModelDefinition(
            ...
            std::make_shared<std::unordered_map<Identifier, double>>(),
            std::make_shared<std::unordered_map<Identifier, int>>(),
            std::make_shared<std::unordered_map<Identifier, double>>(), names_, models_, ranges_,
            lambda_, stddev_, cholesky_, policy_models_, policy_ranges_, policy_cholesky_, nullptr,
            nullptr, nullptr, // Empty trend models for Trend type
...
TEST_F(StaticLinearModelTest, StaticLinearModelDefinitionIncomeTrendValidation) {
    ...
    EXPECT_THROW(StaticLinearModelDefinition(
                     ...
                     ranges_, lambda_, stddev_, cholesky_, policy_models_, policy_ranges_,
                     policy_cholesky_, nullptr, nullptr, nullptr, info_speed_, rural_prevalence_,
                     income_models_, physical_activity_stddev_, TrendType::IncomeTrend, nullptr,
                     nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, true),
                 HgpsException);
}
