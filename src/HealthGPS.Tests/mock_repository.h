...
public:
    ...
    std::vector<core::PopulationItem> get_population(
        const core::Country&, std::function<bool(unsigned int)>) const override { return {}; }
    
    std::vector<core::MortalityItem> get_mortality(
        const core::Country&, std::function<bool(unsigned int)>) const override { return {}; }
    ...
    core::DiseaseEntity get_disease(
        const core::DiseaseInfo&, const core::Country&) const override { return {}; }
    
    std::optional<core::RelativeRiskEntity> get_relative_risk_to_disease(
        const core::DiseaseInfo&, const core::DiseaseInfo&) const override { return std::nullopt; }
    
    std::optional<core::RelativeRiskEntity> get_relative_risk_to_risk_factor(
        const core::DiseaseInfo&, core::Gender, const core::Identifier&) const override { return std::nullopt; }
    
    core::CancerParameterEntity get_disease_parameter(
        const core::DiseaseInfo&, const core::Country&) const override { return {}; }
    
    core::DiseaseAnalysisEntity get_disease_analysis(
        const core::Country&) const override { return {}; }
...
public:
    ...
    const RiskFactorModelDefinition& get_risk_factor_model_definition(
        const RiskFactorModelType& model_type) const override {
        ...
        static DummyModelDefinition definition(model_type, std::move(names), std::move(values), std::move(policy), std::move(policy_start));
        return definition;
    }
    ...
    DiseaseDefinition& get_disease_definition(const core::DiseaseInfo& info,
        ...
        static std::map<std::string, int> measures = {
            {MeasureKey::prevalence, 0},
        ...
        static std::map<int, std::map<core::Gender, DiseaseMeasure>> data = {
            {0, {{core::Gender::male, DiseaseMeasure({{0, 0.1}, {1, 0.2}, {2, 0.3}, {3, 0.4}})},
                 {core::Gender::female, DiseaseMeasure({{0, 0.1}, {1, 0.2}, {2, 0.3}, {3, 0.4}})}}},
            {1, {{core::Gender::male, DiseaseMeasure({{0, 0.1}, {1, 0.2}, {2, 0.3}, {3, 0.4}})},
                 {core::Gender::female, DiseaseMeasure({{0, 0.1}, {1, 0.2}, {2, 0.3}, {3, 0.4}})}}}
        };
        ...
        static DiseaseDefinition definition(std::move(disease_table), 
                                                std::move(diseases),
    ...
    LmsDefinition& get_lms_definition() override {
        static LmsDataset dataset = {
            {18, {{core::Gender::male, LmsRecord{1.0, 22.0, 3.0}},
