...
TEST(TestCore, TableColumnIterator) {
    ...
    // Calculate the sum manually using the value_unsafe method for every valid cell
    ...
    ASSERT_EQ(sum, loop_sum);        // Verify std::accumulate works as expected
}
