...
namespace hgps {
	FiscalPolicyScenario::FiscalPolicyScenario(
		SyncChannel& data_sync, FiscalPolicyDefinition&& definition)
	...
	ScenarioType FiscalPolicyScenario::type() const noexcept {
	...
	void FiscalPolicyScenario::clear() noexcept {
