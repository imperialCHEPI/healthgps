...
class StaticLinearModel final : public RiskFactorAdjustableModel {
  ...
  private:
    ...
    /// @brief Build extended factors list including income and physical activity if they exist in
    /// expected table
    ...
    /// @return Pair of (extended_factors, extended_ranges) with income/physical activity added if
    /// available
