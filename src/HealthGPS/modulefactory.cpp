...
void SimulationModuleFactory::register_builder(const SimulationModuleType type,
                                               const ConcreteBuilder builder) {

    builders_.emplace(type, builder);
}

SimulationModuleFactory::ModuleType SimulationModuleFactory::create(const SimulationModuleType type,
