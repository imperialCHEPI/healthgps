    ...
    try {
        ...
        if (channels_.empty()) {
            ...
            if (channels_.empty()) {
                ...
                // std::cout << "DEBUG: Successfully initialized " << channels_.size() << "
                // channels" << std::endl;
            }
        }
        ...
        // std::endl; std::cout << "DEBUG: Starting historical statistics calculation..." <<
        // std::endl;
        ...
        try {
            ...
            // std::cout << "DEBUG: Started async calculation of historical statistics" <<
            // std::endl;
        } catch (const std::exception &e) {
        ...
        if (historical_stats_success) {
            try {
                // std::cout << "DEBUG: Waiting for historical statistics calculation to
                // complete..." << std::endl;
                handle.get();
