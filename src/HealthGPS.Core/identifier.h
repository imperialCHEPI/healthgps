...
namespace hgps::core {
	...
	struct Identifier final
	{
		...
		/// @exception std::invalid_argument for value starting with a number or containing invalid characters. 
		Identifier(const char* const value);

		/// @brief Initialises a new instance of the hgps::core::Identifier class
		/// @param value The string identifier
		/// @throws std::invalid_argument for value starting with a number or containing invalid characters. 
