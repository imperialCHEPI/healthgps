...
void EventMonitor::info_dispatch_thread() {
    fmt::print(fmt::fg(fmt::color::light_blue), "Info event thread started...\n");
    ...
    fmt::print(fmt::fg(fmt::color::light_blue), "Info event thread exited.\n");
}

void EventMonitor::result_dispatch_thread() {
    fmt::print(fmt::fg(fmt::color::gray), "Result event thread started...\n");
    while (!tg_context_.is_group_execution_cancelled()) {
        std::shared_ptr<hgps::EventMessage> m;
    ...
    fmt::print(fmt::fg(fmt::color::gray), "Result event thread exited.\n");
}
} // namespace hgps
