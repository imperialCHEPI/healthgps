...
TEST(TestRelativeRiskLookup, InterpolateValueLookup) {
	...
	for (size_t i = 0; i < test_values.size(); i++) {
		...
		if (value <= lut_cols.front()) {
			...
			auto it = std::find_if(lut_cols.begin(), lut_cols.end(), [&value](auto v) { return value < v; });
...
TEST(TestRelativeRiskLookup, ReferenceDataLookup) {
	auto test_age = 3;
	auto test_data = std::map<double, double>{
		{ 16.0, 1.00 },  { 16.5, 1.00 }, { 17.0, 1.0 }, {17.5, 1.00 }, {18.0, 1.00 }, 
		{ 18.5, 1.2285714285714286 }, {19.0, 1.4571428571428573 }, { 19.5, 1.6857142857142859 },
		{ 20.0, 1.9142857142857144 }, {20.5, 2.1428571428571428 }, { 21.0, 2.3714285714285719 },
		{ 21.5, 2.60 },  { 22.0, 2.8285714285714287 }, {22.5, 3.0571428571428574 }, 
		{ 23.0, 3.2857142857142856}, { 23.5, 3.5142857142857147 }, {24.0, 3.7428571428571433 },
		{ 24.5, 3.9714285714285715 }, { 25.0, 4.2 },      { 25.5, 4.51 }, { 26.0, 4.82 }, { 26.5, 5.13 },
		{ 27.0, 5.440},  { 27.5, 5.75 }, { 28.0, 6.06 },   { 28.5, 6.37 }, { 29.0, 6.68 }, { 29.5, 6.99 },
		{ 30.0, 7.30 },  { 30.5, 7.62 },   { 31.0, 7.94 },   { 31.5, 8.26 }, { 32.0, 8.58 }, { 32.5, 8.90 },
		{ 33.0, 9.22 },  { 33.5, 9.54 },   { 34.0, 9.86 },   { 34.5, 10.18}, { 35.0, 10.5 }, { 35.5, 10.80 },
		{ 36.0, 11.10 }, { 36.5, 11.40 }, { 37.0, 11.7 }, { 37.5, 12.00 }, { 38.0, 12.3 }, { 38.5, 12.60 },
		{ 39.0, 12.90 }, { 39.5, 13.20 }, { 40.0, 13.5},  { 40.5, 13.50}, { 41.0, 13.5 }, { 41.5, 13.50 }
	};
