...
function(enable_doxygen DOXYGEN_THEME)
    ...
    if("${DOXYGEN_THEME}" STREQUAL "awesome" OR "${DOXYGEN_THEME}" STREQUAL "awesome-sidebar")
        # use a modern doxygen theme https://github.com/jothepro/doxygen-awesome-css v2.1.0
    ...
    elseif("${DOXYGEN_THEME}" STREQUAL "original")
        ...
        foreach(file ${DOXYGEN_THEME})
            if(NOT EXISTS ${file})
                message(
                    WARNING "Could not find doxygen theme file '${file}'. Using original theme.")
    ...
    if(DOXYGEN_FOUND)
        message(
            STATUS
                "Adding `doxygen-docs` target that builds the documentation. Source: ${PROJECT_SOURCE_DIR}"
        )
        doxygen_add_docs(
            doxygen-docs ALL ${PROJECT_SOURCE_DIR}/src ${PROJECT_SOURCE_DIR}/README.md
            COMMENT
