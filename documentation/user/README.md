...
| [Configuration schemas](schemas.md) | JSON Schema layout, validation, v1/v2 overview (diagrams) |
| [Models overview](models-overview.md) | Simulation modules and RF models â€” inputs/outputs (diagrams) |
